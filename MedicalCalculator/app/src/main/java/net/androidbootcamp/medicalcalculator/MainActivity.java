...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final RadioButton kiloToLb = (RadioButton)findViewById(R.id.radKiloToPounds);
            ...
            public void onClick(View v) {
                ...
                if(lbToKilo.isChecked()){
                    if(weightEntered <= 500){
                        convertedWeight = weightEntered / converionRate;
                        result.setText(tenth.format(convertedWeight) + " kilogram");
                    }
                    else{
